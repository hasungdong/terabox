    ...
    xhr.onreadystatechange = function () {
        ...
        <ul>
            ...
            `, 'text/html').querySelector('li');
                ...
                deleteMovieForm.divResult.append(pageContainer);
        ...
        const pages = deleteMovieForm.divResult.querySelectorAll('.page');
        pages.forEach(page => page.onclick = () => {
            showMoviesDelete(page.innerText);
        });
    }
    xhr.open('GET', `/movie/search?keyword=${deleteMovieForm['title'].value}&page=${page}`);
    xhr.send();
    loading.show();
}