...
addProductForm.subTitleLabel = new LabelObj(addProductForm.querySelector('[rel="subTitleLabel"]'));
...
addProductForm.onsubmit = e => {
    ...
    addProductForm.typeLabel.setValid(addProductForm['type'].value === 'ticket' ||
        addProductForm['type'].value === 'fdg' ||
        addProductForm['type'].value === 'point');
    addProductForm.subTitleLabel.setValid(addProductForm['subTitle'].tests());
    ...
    !addProductForm.subTitleLabel.isValid()){
        return;
    }
    ...
    formData.append('subTitle', addProductForm['subTitle'].value);
